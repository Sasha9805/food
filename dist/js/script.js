...
function cards() {
  ...
  class MenuCard {
    ...
    render() {
      const element = document.createElement('div'); // С урока
...
function forms(modalTimerId) {
  // Forms
  const forms = document.forms; // Для блока после формы - состояние запроса для пользователя
  ...
  function bindPostData(form) {
    form.addEventListener('submit', event => {
      ...
      const json = JSON.stringify(Object.fromEntries(formData.entries())); // Отправим
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_2__["postData"])('http://localhost:3000/requests', json) // response.json() - сработает catch, а от сервера получим NULL
  ...
  function showThanksModal(message) {
    const prevModalDialog = document.querySelector('.modal__dialog'); // Нужно скрывать, а не удалять, чтобы в дальнейшем пользоваться изначальным функционалом

    prevModalDialog.classList.add('hide'); // Заново открываем

    Object(_modal__WEBPACK_IMPORTED_MODULE_1__["openModal"])('.modal', modalTimerId); // Формируем новое modal__dialog
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const modalTimerId = setTimeout(() => Object(_modules_modal__WEBPACK_IMPORTED_MODULE_3__["openModal"])('.modal', modalTimerId), 7000);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2023-03-24 18:58:00');
  Object(_modules_cards__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_7__["default"])(modalTimerId);
